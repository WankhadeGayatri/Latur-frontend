...
//           try {
//             const imageResponse = await axios.get<HostelImage[]>(
...
//       await axios.delete(`http://localhost:5000/api/hostels/delete/${id}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
function ViewHostels() {
  return <div>Something error in build so we trying ...</div>;
}
