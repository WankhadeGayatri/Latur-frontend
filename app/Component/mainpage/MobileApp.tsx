...
const MobileApp: React.FC = () => {
  ...
  const [currentSupportSlide, setCurrentSupportSlide] = useState<number>(0);
  ...
  useEffect(() => {
    ...
    if (app && welcome && support && home) {
      gsap.set([app, welcome, support, home], { autoAlpha: 0 });

      const tl = gsap.timeline({ defaults: { ease: "power3.out" } });
      tl.to(app, { autoAlpha: 1, duration: 1 }).to(welcome, {
        autoAlpha: 1,
        y: 0,
        duration: 0.5,
      });
  ...
  const WelcomeScreen: React.FC = () => (
    <div
      ref={welcomeRef}
      className="absolute inset-0 pt-12 pb-20 px-4 flex flex-col items-center justify-center bg-white"
    >
      ...
      <button className="mt-4 bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition duration-300 ease-in-out transform hover:scale-105">
        Explore Hostels
      </button>
    </div>
  );
  ...
  const SupportScreen = () => {
    ...
    return (
      <div className="absolute inset-0 pt-12 pb-20 px-4 bg-gradient-to-br from-blue-50 to-purple-50">
  ...
  const HomeScreen: React.FC = () => {
    ...
    return (
      <div className="absolute inset-0 pt-12 pb-20 px-4 bg-gray-50 overflow-y-auto">
        ...
        <div className="mb-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            <p className="text-gray-600 italic">
              ...
              my studies and make lifelong friends. The amenities are
              top-notch!"
            </p>
  ...
  return (
    <div className="relative mt-10 flex items-center justify-center h-screen overflow-hidden">
      {/* Background bubbles */}
      <div className="absolute top-1 left-0 w-[300px] h-[300px] bg-sky-200 rounded-full opacity-50"></div>
      {/* <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-sky-300 rounded-full opacity-50"></div> */}
      <div className="absolute top-1/2 left-1/2 w-[200px] h-[200px] bg-sky-400 rounded-full opacity-30"></div>
      <div
        ref={appRef}
...
>
  <ChevronRight size={18} />
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/2 left-1/2 w-[400px] h-[400px] bg-sky-300 rounded-full -translate-x-1/2 -translate-y-1/2 -z-10"></div>
      <div className="absolute left-10 top-1/2 transform -translate-y-1/2">
        <div className="bg-white rounded-full p-4 shadow-lg">
          <ThumbsUp size={32} className="text-sky-500" />
        </div>
      </div>
    </div>
  );
