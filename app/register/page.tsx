  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        if (studentRole) {
          setStudentRoleId(studentRole._id);
        }
      })
            ...
            <div className="relative lg:w-1/4">
              <div className="absolute inset-0 z-0">
                <div className="w-full h-full relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-transparent via-purple-900/30 to-purple-900/50" />
                </div>
              </div>
      ...
      >
        ...
        >
          <Typography id="modal-terms-title" variant="h6" component="h2">
            Student Terms, Conditions, and Benefits
          </Typography>
